...
export function SpeakersSection() {
  const speakers = [
    /* Speaker objects can be added here */
  ];

  return (
    <section id="speakers" className="py-20 bg-teal-50" data-testid="speakers-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card
            ...
            data-testid="more-speakers-card"
          >
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-3">Additional Presentations</p>
